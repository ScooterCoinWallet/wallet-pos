# Support for Output Descriptors in Scootercoin Core

Since Scootercoin Core v0.17, there is support for Output Descriptors. This is a
...
on Scootercoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Scootercoin Core wallets, a convenience function `combo` is
...
All RPCs in Scootercoin Core will include the checksum in their output. Only
