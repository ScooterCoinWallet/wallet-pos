...
`./`               | `debug.log`           | Contains debug information and general logging generated by `scootercoind` or `scootercoin-qt`; can be specified by `-debuglogfile` option
