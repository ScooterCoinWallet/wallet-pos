 ...
 *  A CTxDestination is the internal data type encoded in a scootercoin address
 */
...
/**
 * Generate a Scootercoin scriptPubKey for the given CTxDestination. Returns a P2PKH
