...
public:
     ...
     * on this scootercoin node, and set to 0 for transactions that were created
...
private:
    ...
    void StakeSCOOTs(bool fStake, CConnman* connman, CTxMemPool* mempool);
