...
# TestP2PConn: A peer we use to send messages to scootercoind, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes scootercoind to (reasonably!) disconnect us, so do this last.
    ...
    # scootercoind's choice of nonce.
    ...
    # Test that scootercoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for scootercoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # scootercoind will not send blocktxn responses for blocks whose height is
