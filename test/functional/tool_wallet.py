...
class ToolWalletTest(BitcoinTestFramework):
    ...
    def bitcoin_wallet_process(self, *args):
        binary = self.config["environment"]["BUILDDIR"] + '/src/scootercoin-wallet' + self.config["environment"]["EXEEXT"]
    ...
    def test_invalid_tool_commands_and_args(self):
        ...
        # `scootercoin-wallet help` raises an error. Use `scootercoin-wallet -help`.
